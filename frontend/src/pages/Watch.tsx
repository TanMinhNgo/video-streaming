...
import { fetchComments, fetchStreamUrl, fetchVideoDetail, postComment, toggleLike } from "@/api/videos";
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <Button onClick={() => likeMutation.mutate()} type="button">
            Like ({videoQuery.data.likeCount})
          </Button>
          <span className="text-sm text-muted-foreground">{videoQuery.data.viewCount.toLocaleString()} views</span>
          </div>
        </CardContent>
      </Card>
      <Card>
